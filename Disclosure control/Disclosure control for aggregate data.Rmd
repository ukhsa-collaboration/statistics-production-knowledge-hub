...
When preparing numerical information for publication, a number of steps should be taken to assess the risk of accidental disclosure (based on those outlined by the GSS `r addRef(2)`).
