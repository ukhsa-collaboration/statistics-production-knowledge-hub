...
versioncontrol: "`r ukhsaGuidanceDocs::VersionHistory( c('10/11/2022', 'Second draft'), c('03/11/2022', 'First draft')  )`"
---
...
* <input type="checkbox"> integrate quality assurance checks throughout the analysis, automated where appropriate, supplemented with semi-automated and manual checks ([we will be producing further guidance on this in due course](https://github.com/UKHSA-Statistics-Production/knowledge-hub/blob/main/README.md)) 
